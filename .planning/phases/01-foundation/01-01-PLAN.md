...
<objective>
Create the foundational CLI skeleton for gsd-for-hobos with all standard flags working.
...
<task type="auto">
  ...
  <action>
    ...
    - Log info "GSD-for-Hobos initialized" (placeholder for now)
