...
must_haves:
  truths:
    - "User sees Hobo Manifesto text when running CLI"
  ...
  artifacts:
    - path: "src/lib/manifesto.ts"
      provides: "Hobo Manifesto display and consent logic"
...
<objective>
Add the Hobo Manifesto disclaimer and consent flow to the CLI.
...
Output: Users see the Hobo Manifesto on launch, must accept to continue, and can gracefully decline.
</objective>
...
<task type="auto">
  <name>Task 1: Create Hobo Manifesto module with consent flow</name>
  <files>
    src/lib/manifesto.ts
  </files>
  <action>
    ...
    2. Display the Hobo Manifesto text with ASCII art border (use console.log)
    ...
    5. If declined or cancelled:
       - Call outro() with "Manifesto declined. Safe travels, hobo."
       - Return false
    6. If accepted:
